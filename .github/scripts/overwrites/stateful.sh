...
npm pkg set contributes.configuration[0].properties[runme.features.forceLogin].default=true --json
...
npm pkg set contributes.configuration[0].properties[runme.features.gist].default=false --json
