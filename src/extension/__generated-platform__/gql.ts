...
const documents = {
    ...
    "query getAllWorkflows($page: Int!, $take: Int, $fileName: String, $all: Boolean) {\n  workflows(page: $page, take: $take, fileName: $fileName, all: $all) {\n    data {\n      id\n      description\n      fileName\n      path\n      repository\n      rating {\n        id\n        rating\n        __typename\n      }\n      organizationId\n      totalRatings\n      bookmark {\n        id\n        __typename\n      }\n      tags {\n        id\n        name\n        __typename\n      }\n      __typename\n    }\n    meta {\n      totalPages\n      total\n      __typename\n    }\n    __typename\n  }\n}": types.GetAllWorkflowsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query getAllWorkflows($page: Int!, $take: Int, $fileName: String, $all: Boolean) {\n  workflows(page: $page, take: $take, fileName: $fileName, all: $all) {\n    data {\n      id\n      description\n      fileName\n      path\n      repository\n      rating {\n        id\n        rating\n        __typename\n      }\n      organizationId\n      totalRatings\n      bookmark {\n        id\n        __typename\n      }\n      tags {\n        id\n        name\n        __typename\n      }\n      __typename\n    }\n    meta {\n      totalPages\n      total\n      __typename\n    }\n    __typename\n  }\n}"): (typeof documents)["query getAllWorkflows($page: Int!, $take: Int, $fileName: String, $all: Boolean) {\n  workflows(page: $page, take: $take, fileName: $fileName, all: $all) {\n    data {\n      id\n      description\n      fileName\n      path\n      repository\n      rating {\n        id\n        rating\n        __typename\n      }\n      organizationId\n      totalRatings\n      bookmark {\n        id\n        __typename\n      }\n      tags {\n        id\n        name\n        __typename\n      }\n      __typename\n    }\n    meta {\n      totalPages\n      total\n      __typename\n    }\n    __typename\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
