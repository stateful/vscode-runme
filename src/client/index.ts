    ...
    renderOutputItem(outputItem, element) {
      ...
      switch (payload.type) {
        ...
        case OutputType.outputItems:
           ...
           */
          const outputItemElem = document.createElement(
            RENDERERS.ShellOutputItems
          )
        ...
        case OutputType.annotations:
          ...
          annoElem.setAttribute(
            'annotations',
            JSON.stringify(payload.output.annotations ?? [])
          )
          annoElem.setAttribute(
            'validationErrors',
        ...
        case OutputType.terminal:
          ...
          terminalElement.setAttribute(
            'terminalFontFamily',
            payload.output.terminalFontFamily
          )
          terminalElement.setAttribute(
            'terminalFontSize',
          ...
          if (payload.output.initialRows !== undefined) {
            terminalElement.setAttribute(
              'initialRows',
              payload.output.initialRows.toString()
            )
          }
        ...
        case OutputType.github:
          const githubElement = document.createElement(
            RENDERERS.GitHubWorkflowViewer
          )
