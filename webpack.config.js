...
const makeConfig = (argv, { entry, out, target, library = 'commonjs', experiments }) => ({
    mode: argv.mode,
...
module.exports = (env, argv) => [
    makeConfig(argv, { entry: './src/client/index.ts', out: './out/client/index.js', target: 'web', library: 'module', experiments: { outputModule: true } }),
